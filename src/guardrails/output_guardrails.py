    ...
    async def after_model_callback(
        ...
        *,
        ...
        if not filter_result["safe"]:
            ...
            modified_text = filter_result["redacted"]
        ...
        if self.use_llm_judge:
            ...
            if not judge_result["safe"]:
                ...
                modified_text = "I cannot provide that information due to security policy."

        # Update llm_response.content if text was modified
